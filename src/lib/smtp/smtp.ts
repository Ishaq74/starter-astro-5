...
const smtpConfig = {
  ...
  auth: {
    ...
    // Support both SMTP_PASS and SMTP_PASSWORD (tasks requirement vs existing code)
    pass: process.env.SMTP_PASS || process.env.SMTP_PASSWORD || import.meta.env.SMTP_PASS || import.meta.env.SMTP_PASSWORD || ''
  },
