...
- [ ] T004 Configure `src/styles/global.css` design tokens (colors, spacing, typography, radii)
- [ ] T005 Add light/dark token overrides with `[data-theme]`
- [ ] T006 [P] Run `scripts/contrast-check.js` and record results in PR description
...
- [ ] TXXX Verify token coverage (no hard-coded colors) and rerun contrast checks
